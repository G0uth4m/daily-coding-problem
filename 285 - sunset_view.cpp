...
from east to west. The city assessor would like you to write an algorithm that 
...
int numViewable(vector<int>& buildings) {
    int res = 0;
...
int main() {
    vector<int> buildings = {3, 7, 8, 3, 6, 1};
    cout << numViewable(buildings) << endl;
}
